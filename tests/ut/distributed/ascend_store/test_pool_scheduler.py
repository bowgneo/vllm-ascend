...
class TestKVPoolScheduler(unittest.TestCase):
    ...
    def test_init_logs_scheduler_config(self, mock_logger, mock_client_cls):
        ...
        self.assertIn(
            "event=kv_pool_scheduler_configured backend=%s page_size_bytes=%d "
    ...
    def test_get_num_new_matched_tokens_hit(self, mock_logger, mock_client_cls):
        ...
        self.assertIn("event=kv_pool_lookup_completed", mock_logger.info.call_args_list[0].args[0])
        self.assertIn("event=kv_pool_load_spec_created", mock_logger.info.call_args_list[1].args[0])
...
class TestKVPoolSchedulerGetLayerwiseGvaHitTokens(unittest.TestCase):
    ...
    def test_result_count_mismatch_logs_structured_error(self, mock_logger):
        ...
        self.assertIn("event=kv_pool_lookup_result_invalid", message)
