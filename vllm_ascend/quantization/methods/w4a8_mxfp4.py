...
class AscendW4A8MXFPDynamicFusedMoEMethod(AscendMoEScheme):
    ...
    def process_weights_after_loading(self, layer):
        ...
        if get_ascend_config().enable_fused_mc2 == 1:
            ...
            layer.w13_weight_scale.data = layer.w13_weight_scale.data.reshape(g, n, k // 2, 2).transpose(1, 2).contiguous()
            g, n, k = layer.w2_weight_scale.shape
            layer.w2_weight_scale.data = layer.w2_weight_scale.data.reshape(g, n, k // 2, 2).transpose(1, 2).contiguous()
